    ...
    <div class="app-wrapper">
        ...
        <section class="section-flex show">
            <div class="image-background">
                <div class="email-box">
                    <h2>
                        Our daily crossword puzzles, which range from
                        beginner-friendly to challenging, plus cryptics, quizzed and
                        other brain-teasing games
                    </h2>
        ...
        <section class="section-flex show">
            <div
                ...
                style="
                background-image: url('image/Frame 455.png');
        ...
        <section class="section-flex show">
            <div class="contributors">
                ...
                <div class="contributor-text-box">
                    ...
                    <p class="discription">
                        Description of post and additional details in support of the
                        detail to provide more information to the reader on the
                        content of the post...
                    </p>
                </div>
            </div>
...
<div class="image-background" style="background-color: #8e8585">
    <div class="email-box">
        <h2 style="width: 300px; line-height: 20px">
            Our daily crossword puzzles, which range from beginner-friendly to
            challenging, plus cryptics, quizzed and other brain-teasing games
        </h2>
...
<div
    ...
    style="
          ...
          background-position: center;
          height: 111px;
          border-top: 40px soild #fbf6ee !important;
        "></div>
